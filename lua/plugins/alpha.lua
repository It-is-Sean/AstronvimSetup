...
╚═╝  ╚═╝╚══════╝   ╚═╝   ╚═╝  ╚═╝ ╚═════╝ 
  N      E      O      V      I      M
    ...
    dashboard.section.buttons.val = {
      ...
      dashboard.button("c", "  Config", "<cmd>lua require('snacks').picker.files({cwd=vim.fn.stdpath('config'),title='Config Files'})<cr>"),
